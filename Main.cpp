...
void GetEnemy(int enemyNumber)
{
	Enemy* enemyPtr = &enemies[enemyNumber];
...
// 1. Create a function that will take in enemy pointer
// 2. Use pointer to display contents of Enemy
// 3. In main loop, pass each item in array to the function